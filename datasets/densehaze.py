...
class Densehaze:
    ...
    def get_loaders(self, parse_patches=True,):
        ...
        print("===> evaluating Densehaze test set...")
        path = os.path.join(self.config.data.data_dir, 'data', 'nhaze')
        filename = 'nhaze.txt'
        ...
        val_dataset = DensehazeDataset( n=self.config.training.patch_n,
                                        patch_size=self.config.data.image_size,
                                        transforms=self.transforms,
                                        parse_patches=parse_patches)
...
class DensehazeDataset(torch.utils.data.Dataset):
    def __init__(self, patch_size, n, transforms, parse_patches=True):
        super().__init__()

        train_list = "densehaze/densehaze.txt"
    ...
    def get_images(self, index):
        ...
        #print(os.path.join(self.dir, input_name))
