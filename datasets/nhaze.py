...
class Nhaze:
    ...
    def get_loaders(self, parse_patches=True,):
        ...
        print("===> evaluating outdoor NH-haze test set...")
        ...
        val_dataset = NHhazeDataset(     n=self.config.training.patch_n,
                                        patch_size=self.config.data.image_size,
                                        transforms=self.transforms,
                                        parse_patches=parse_patches)
...
class NHhazeDataset(torch.utils.data.Dataset):
    def __init__(self, patch_size, n, transforms, parse_patches=True):
        super().__init__()

        train_list = "nhaze/nhaze.txt"
